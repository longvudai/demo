...
//        navigationBar.isTranslucent = false
    ...
    private lazy var label: UILabel = {
        let v = UILabel()
        v.text = "Icon Select Icon Select Icon Select Icon SelectIcon Select Icon Select Icon Select Icon Select Icon Select"
        v.numberOfLines = 0
    ...
    private lazy var settingController: JournalSettingController = {
        let v = JournalSettingController()
        return v
    }()
    ...
    private func setupView() {
        ...
        settingController.willMove(toParent: self)
        view.addSubview(settingController.view)
        settingController.didMove(toParent: self)
        
        settingController.view.snp.makeConstraints {
        ...
        collectionView.snp.makeConstraints {
            ...
            $0.top.equalTo(settingController.view.snp.bottom)
        }
...
//            $0.top.equalTo(settingController.view.snp.bottom)
//            $0.trailing.leading.bottom.equalTo(view.safeAreaLayoutGuide).inset(30)
//        }
    }
